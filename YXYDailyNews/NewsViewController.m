...
static NSString * const collectionCellID = @"ChannelCell";
static NSString * const collectionViewSectionHeaderID = @"ChannelCollectionHeader";
static CGFloat titleLabelNormalFont = 13;
static CGFloat titleLabelSelectedFont = 17;



@interface NewsViewController () <UIScrollViewDelegate, UICollectionViewDataSource, UICollectionViewDelegate, ChannelCollectionViewCellDelegate>
...
-(UIButton *)createChannelButton{
	...
	[button.titleLabel setFont:[UIFont systemFontOfSize:titleLabelNormalFont]];
	[button addTarget:self action:@selector(buttonClick:) forControlEvents:UIControlEventTouchUpInside];
	return button;
}
-(void)buttonClick:(UIButton *)button {
	self.selectButton.titleLabel.font = [UIFont systemFontOfSize:titleLabelNormalFont];
